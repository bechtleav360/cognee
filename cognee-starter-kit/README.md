...
| `src/pipelines/low_level.py` | `examples/custom_pipelines/organizational_hierarchy/` |
| `src/pipelines/custom-model.py` | `examples/demos/custom_graph_model_entity_schema_definition.py` |
| `src/data/` | Included in `examples/custom_pipelines/organizational_hierarchy/data/` |
